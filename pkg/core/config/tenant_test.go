		...
		AppConfig: &AppConfiguration{
			...
			MFA: &MFAConfiguration{
				...
				OOB: &MFAOOBConfiguration{
					Sender:  "mfaoobsender@example.com",
					Subject: "mfaoobsubject",
					ReplyTo: "mfaoobreplyto@example.com",
			...
			ForgotPassword: &ForgotPasswordConfiguration{
				SecureMatch:      true,
				Sender:           "myforgotpasswordsender@example.com",
				Subject:          "myforgotpasswordsubject",
				ReplyTo:          "myforgotpasswordreplyto@example.com",
				ResetURLLifetime: 60,
			...
			WelcomeEmail: &WelcomeEmailConfiguration{
				Enabled:     true,
				Sender:      "welcomeemailsender@example.com",
				Subject:     "welcomeemailsubject",
				ReplyTo:     "welcomeemailreplyto@example.com",
				Destination: "first",
			},
			...
			UserVerification: &UserVerificationConfiguration{
				...
				LoginIDKeys: []UserVerificationKeyConfiguration{
					UserVerificationKeyConfiguration{
						...
						Sender:          "userverificationsender@example.com",
						ReplyTo:         "userverificationreplyto@example.com",
					},
				},
			},
