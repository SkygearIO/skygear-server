...
generate-doc-auth:
	@openapi3-gen -output "$(DOC_PATH)" ./cmd/auth/... ./pkg/auth/... ./pkg/core/auth/...
...
generate-static-asset:
	cd ./scripts/deploy-asset; npm ci; rm -rf dist/; npx postcss '../../static/**/*.css' --base '../../static' --dir "./dist/git-$(GIT_SHORT_SHA)" --config postcss.config.js
